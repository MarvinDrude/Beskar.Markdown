...
public sealed class PlainHeaderRenderer : INodeRenderer
{
      ...
      RenderOptions options)
   {
      ...
      {
         RecordUniqueSlug(context, current, nodes, rawText);
      }
   ...
   private static void RecordUniqueSlug<TData>(
      MarkdownContext<TData> context,
      in MarkdownNode header,
      ReadOnlySpan<MarkdownNode> nodes,
      ReadOnlySpan<char> rawText)
   {
